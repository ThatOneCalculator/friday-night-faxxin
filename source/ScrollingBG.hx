 ...
 * @author Chevy Ray
 */
class ScrollingBG extends FlxSprite
{
	var _ppoint:Point;
	var _scrollW:Int = 0;
	var _scrollH:Int = 0;
	 ...
	 */
	public function new(?Graphic:String, ScrollX:Float = 1, ScrollY:Float = 1, RepeatX:Bool = true, RepeatY:Bool = true, SpaceX:Int = 0,
			SpaceY:Int = 0)
	{
		super();
	...
	public function loadFrame(Frame:FlxFrame):ScrollingBG
	{
		setTileFrame(Frame);
