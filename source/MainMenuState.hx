...
{
	public static var modVersion:String = '1.0.2';
	...
	override function create()
	{
		...
		DiscordClient.changePresence("In the Menus", null, 'icon');
		#end
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Friday Night Faxxin' v" + modVersion, 12);
